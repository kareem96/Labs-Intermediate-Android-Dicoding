package com.crm.siska.ui.leads.my_leads.aktif
...
class MyAktifFragment : Fragment(), MyAktifAdapter.ItemAdapterCallback, LeadsContract.View {

    private var leads : ArrayList<Data>? = ArrayList()
    private lateinit var presenter: MyAktifPresenter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_my_aktif, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initView()
        presenter = MyAktifPresenter(this)
        presenter.getLeads()
    }
    ...
    override fun onLeadsSuccess(leadsResponse: LeadsResponse) {
        ...
        var adapter = MyAktifAdapter(leadsResponse.data, this)
