package com.crm.siska.ui.leads.dev_leads.hot
...
class DevHotFragment : Fragment(), DevHotAdapter.ItemAdapterCallback, LeadsContract.View {

    private var leads : ArrayList<Data>? = ArrayList()
    private lateinit var presenter: DevHotPresenter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dev_hot, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initView()
        presenter = DevHotPresenter(this)
        presenter.getLeads()
    }
    ...
    override fun onLeadsSuccess(leadsResponse: LeadsResponse) {
        ...
        var adapter = DevHotAdapter(leadsResponse.data, this)
