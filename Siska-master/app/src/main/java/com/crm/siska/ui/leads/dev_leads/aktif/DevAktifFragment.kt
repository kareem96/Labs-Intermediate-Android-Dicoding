package com.crm.siska.ui.leads.dev_leads.aktif
...
import kotlinx.android.synthetic.main.fragment_dev_aktif.*

class DevAktifFragment : Fragment(), DevAktifAdapter.ItemAdapterCallback, LeadsContract.View {

    private var leads : ArrayList<Data>? = ArrayList()
    private lateinit var presenter: DevAktifPresenter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dev_aktif, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initView()
        presenter = DevAktifPresenter(this)
        presenter.getLeads()
    }
    ...
    override fun onLeadsSuccess(leadsResponse: LeadsResponse) {
        ...
        var adapter = DevAktifAdapter(leadsResponse.data, this)
