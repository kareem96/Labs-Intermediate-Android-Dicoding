package com.crm.siska.ui.leads.dev_leads.arsip
...
class DevArsipFragment : Fragment(), DevArsipAdapter.ItemAdapterCallback, LeadsContract.View {


    private var leads : ArrayList<Data>? = ArrayList()
    private lateinit var presenter: DevArsipPresenter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_dev_arsip, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initView()
        presenter = DevArsipPresenter(this)
        presenter.getLeads()
    }
    ...
    override fun onLeadsSuccess(leadsResponse: LeadsResponse) {
        ...
        var adapter = DevArsipAdapter(leadsResponse.data, this)
