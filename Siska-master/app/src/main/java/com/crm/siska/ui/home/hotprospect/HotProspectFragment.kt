...
import kotlinx.android.synthetic.main.fragment_hot_prospect.*

class HotProspectFragment : Fragment(), MyHotAdapter.ItemAdapterCallback, LeadsContract.View  {

    private var leads : ArrayList<Data>? = ArrayList()
    private lateinit var presenter: MyHotPresenter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_hot_prospect, container, false)
    }
    ...
    override fun onLeadsSuccess(leadsResponse: LeadsResponse) {
        ...
        var adapter = MyHotAdapter(leadsResponse.data, this)
