package com.crm.siska.ui.leads.all_leads.aktif
...
class AllAktifFragment : Fragment(), AllAktifAdapter.ItemAdapterCallback, LeadsContract.View{

    private var leads : ArrayList<Data>? = ArrayList()
    private lateinit var presenter: AllAktifPresenter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_all_aktif, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initView()
        presenter = AllAktifPresenter(this)
        presenter.getLeads()
    }
    ...
    override fun onLeadsSuccess(leadsResponse: LeadsResponse) {
        ...
        var adapter = AllAktifAdapter(leadsResponse.data, this)
