package com.kareemdev.likesapp
...
import com.kareemdev.likesapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val message = "Apakah kamu suka coding?"
    ...
    private fun showEyes(){
        ...
        mCanvas.drawCircle(halfOfHeight - 100F, halfOfHeight - 10F, 50F, mPaint)
